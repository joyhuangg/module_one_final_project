...
Ingredient.create(name: "Vegetable")
...
Ingredient.create(name: "Porgy")
# Ingredient.create(name: "Armored Porgy")
Ingredient.create(name: "Hearty Truffle")
Ingredient.create(name: "Bird Egg")
Ingredient.create(name: "Bladed Rhino Beetle")
Ingredient.create(name: "Blue Nightshade")
Ingredient.create(name: "Bokoblin Fang")
Ingredient.create(name: "Bokoblin Guts")
Ingredient.create(name: "Bokoblin Horn")
...
Ingredient.create(name: "Chuchu Jelly")
Ingredient.create(name: "Cold Darner")
Ingredient.create(name: "Cool Safflina")
Ingredient.create(name: "Courser Bee Honey")
Ingredient.create(name: "Dinraal's Claw")
Ingredient.create(name: "Dinraal's Scale")
Ingredient.create(name: "Electric Darner")
Ingredient.create(name: "Electric Keese Wing")
...
Ingredient.create(name: "Energetic Rhino Beetle")
Ingredient.create(name: "Fairy")
Ingredient.create(name: "Farosh's Claw")
Ingredient.create(name: "Farosh's Scale")
Ingredient.create(name: "Fire Keese Wing")
Ingredient.create(name: "Fireproof Lizard")
...
Ingredient.create(name: "Hinox Guts")
Ingredient.create(name: "Hinox Toenail")
Ingredient.create(name: "Hinox Tooth")
Ingredient.create(name: "Hot-Footed Frog")
...
Ingredient.create(name: "Ice Keese Wing")
Ingredient.create(name: "Icy Lizalfos Tail")
# Ingredient.create(name: "Ironshroom")
Ingredient.create(name: "Keese Eyeball")
Ingredient.create(name: "Keese Wing")
Ingredient.create(name: "Lizalfos Horn")
Ingredient.create(name: "Lizalfos Tail")
Ingredient.create(name: "Lizalfos Talon")
Ingredient.create(name: "Lynel Guts")
Ingredient.create(name: "Lynel Hoof")
Ingredient.create(name: "Lynel Horn")
...
Ingredient.create(name: "Moblin Fang")
Ingredient.create(name: "Moblin Guts")
Ingredient.create(name: "Moblin Horn")
Ingredient.create(name: "Molduga Fin")
Ingredient.create(name: "Molduga Guts")
Ingredient.create(name: "Monster Extract")
Ingredient.create(name: "Naydra's Claw")
Ingredient.create(name: "Naydra's Scale")
Ingredient.create(name: "Octo Balloon")
Ingredient.create(name: "Octorok Eyeball")
Ingredient.create(name: "Octorok Tentacle")
...
Ingredient.create(name: "Red Chuchu Jelly")
Ingredient.create(name:"Red Lizalfos Tail")
Ingredient.create(name:"Restless Cricket")
Ingredient.create(name:"Rock Salt")
Ingredient.create(name:"Rugged Rhino Beetle")
# Ingredient.create(name:"Rushroom")
Ingredient.create(name:"Sanke Carp")
Ingredient.create(name:"Shard of Dinraal's Fang")
Ingredient.create(name:"Shard of Dinraal's Horn")
Ingredient.create(name:"Shard of Farosh's Fang")
Ingredient.create(name:"Shard of Farosh's Horn")
Ingredient.create(name:"Shard of Naydra's Fang")
Ingredient.create(name:"Shard of Naydra's Horn")
Ingredient.create(name:"Silent Princess")
# Ingredient.create(name:"Silent Shroom")
Ingredient.create(name:"Sizzlefin Trout")
Ingredient.create(name:"Smotherwing Butterfly")
...
Ingredient.create(name:"Star Fragment")
Ingredient.create(name:"Stealthfin Trout")
Ingredient.create(name:"Summerwing Butterfly")
Ingredient.create(name:"Sunset Firefly")
...
Ingredient.create(name:"Thunderwing Butterfly")
Ingredient.create(name:"Tireless Frog")
Ingredient.create(name:"Voltfin Trout")
Ingredient.create(name: "Voltfruit")
Ingredient.create(name:"Warm Darner")
Ingredient.create(name:"Warm Safflina")
Ingredient.create(name:"White Chuchu Jelly")
Ingredient.create(name:"Wildberry")
Ingredient.create(name:"Winterwing Butterfly")
Ingredient.create(name:"Yellow Chuchu Jelly")
Ingredient.create(name:"Yellow Lizalfos Tail")
...
IngredientRecipe.create(recipe_id: Recipe.find_by(name:"Veggie Rice Balls").id, ingredient_id:Ingredient.find_by(name:"Vegetable").id)
...
IngredientRecipe.create(recipe_id: Recipe.find_by(name:"Salt-Grilled Greens").id, ingredient_id:Ingredient.find_by(name:"Vegetable").id)
...
IngredientRecipe.create(recipe_id: Recipe.find_by(name:"Salt-Grilled Mushrooms").id, ingredient_id:Ingredient.find_by(name:"Mushroom").id)
...
IngredientRecipe.create(recipe_id: Recipe.find_by(name:"Steamed Mushrooms").id, ingredient_id:Ingredient.find_by(name:"Mushroom").id)
IngredientRecipe.create(recipe_id: Recipe.find_by(name:"Steamed Mushrooms").id, ingredient_id:Ingredient.find_by(name:"Vegetable").id)

#any mushroom
Recipe.create(name: "Mushroom Skewer")
IngredientRecipe.create(recipe_id: Recipe.find_by(name:"Mushroom Skewer").id, ingredient_id:Ingredient.find_by(name:"Mushroom").id)

Recipe.create(name: "Fried Wild Greens")
IngredientRecipe.create(recipe_id: Recipe.find_by(name:"Fried Wild Greens").id, ingredient_id:Ingredient.find_by(name:"Vegetable").id)
...
IngredientRecipe.create(recipe_id: Recipe.find_by(name:"Glazed Mushrooms").id, ingredient_id:Ingredient.find_by(name:"Mushroom").id)
...
IngredientRecipe.create(recipe_id: Recipe.find_by(name:"Glazed Veggies").id, ingredient_id:Ingredient.find_by(name:"Vegetable").id)
