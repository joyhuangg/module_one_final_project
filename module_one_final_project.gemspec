...
require "module_one_final_project/version"

Gem::Specification.new do |spec|
  spec.name          = "module_one_final_project"
  spec.license       = "MIT"
  spec.version       = ModuleOneFinalProject::VERSION
  spec.authors       = ["joyhuangg"]
  spec.email         = ["joyhuangg@gmail.com"]
